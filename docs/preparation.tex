...
Das NICHT-UND ist eine aus UND und NICHT zusammengeschaltete Verknüpfung, welche
das Ergebnis einer \emph{UND} Verknüpfung negiert. Das NICHT-UND wird auch als 
NUND bezeichnet und wird im Englischen \emph{NAND} genannt. 
...
Das NICHT-ODER ist eine aus ODER und NICHT zusammengeschaltete Verknüpfung, 
welche das Ergebnis einer \emph{ODER} Verknüpfung negiert. Das NICHT-ODER wird
auch als NODER bezeichnet und wird im Englischen \emph{NOR} genannt.
...
Das Exklusiv-ODER ist ein zusammengeschaltetes Element aus XNOR und NICHT, 
welches das Ergebnis einer \emph{XNOR} Verknüpfung negiert. Das Exklusiv-ODER
wird auch als Antivalenz bezeichnet und wird im Englischen \emph{XOR} genannt. 
...
Das Exklusiv-NICHT-ODER ist eine zusammengeschaltete Verknüpfung, dessen Ausgang
immer dann 1 ist, wenn alle Eingänge 2 sind. Das Exklusiv-NICHT-ODER wird auch
als Äquivalenz bezeichnet und wird im Englischen \emph{XNOR} genannt. 
